<?php
    ...
    <div class="add_user_form priceForm">
        ...
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:1rem; padding:0;">
                ...
                <div class="data" style="width:20%">
                    <label for="sales_price">Regular (₦)</label>
               ...
               <!-- <div class="data" style="width:21%">
                ...
                <div class="data" style="width:20%">
                    <label for="sales_price">Express (₦)</label>
                    <input type="text" name="express" id="express" value="<?php echo $row->express?>">
                </div>
                <!-- <div class="data" style="width:21%">
