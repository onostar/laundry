...
<div class="sales_receipt">
    ...
    <table id="postsales_table" class="searchTable" style="border:1px solid #222; border-collapse:collapse">
        <thead>
        ...
        <tbody>
            ...
            ?>
            <tr style="border:1px solid #222; font-size:.9rem;">
    ...
    <!-- other notes -->
        <!-- <h4>Condition</h4> -->
        <p style="font-size:.9rem;"><strong>NB:</strong>This organization is liable to payment of five (5) times the amount of laundry in case of theft or damage.</p>
