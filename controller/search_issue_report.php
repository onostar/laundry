<?php
    ...
    $details = $get_revenue->fetch_details_2dateCon('sales', 'store', 'date(issued_date)', $from, $to, $store);
    $n = 1;
?>
<h2>Issued items between '<?php echo date("jS M, Y", strtotime($from)) . "' and '" . date("jS M, Y", strtotime($to))?>'</h2>
    <hr>
    <div class="search">
...
?>
            <tr>
                ...
                <td style="color:var(--otherColor)"><?php echo date("d-m-Y", strtotime($detail->issued_date));?></td>
