...
<div id="washed" class="displays" style="width:70%!important; margin:50px 20px!important">
    ...
    <div class="stocked_in">
        <div class="displays allResults" id="stocked_items">
            ...
            <table id="stock_items_table" class="searchTable">
                ...
                <tbody>
                    <?php
                        ...
                        $details = $get_items->fetch_details_3cond('sales', 'store', 'invoice', 'laundry_status', $store, $invoice, "W");
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="color:#fff; background:green; padding:5px; border-radius:5px; font-size:.9rem" href="javascript:void(0) "title="wash" onclick="changeStatus('<?php echo $detail->sales_id?>', '<?php echo $invoice?>', 'iron_item.php', 'complete_iron.php')">Iron <i class="fas fa-hands-bubbles"></i></a>
                        </td>
            ...
            ?>
                <button class="page_navs" id="back" onclick="showPage('iron_clothes.php')"><i class="fas fa-angle-double-left"></i> Return</button>
            ...
            <?php
                ...
                <div class="close_stockin">
                    <button onclick="changeAllStatus('<?php echo $invoice?>', 'iron_all.php', 'complete_iron.php')" style="background:green; padding:8px; border-radius:5px;">Iron all <i class="fas fa-check-double"></i></button>
