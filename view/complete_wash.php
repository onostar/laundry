            ...
            <table id="stock_items_table" class="searchTable">
                ...
                <tbody>
                    <?php
                        ...
                        $details = $get_items->fetch_details_3cond('sales', 'store', 'invoice', 'laundry_status', $store, $invoice, "C");
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="color:#fff; background:green; padding:5px; border-radius:5px; font-size:.9rem" href="javascript:void(0) "title="wash" onclick="changeStatus('<?php echo $detail->sales_id?>', '<?php echo $invoice?>', 'wash_item.php', 'complete_wash.php')">Wash <i class="fas fa-hands-bubbles"></i></a>
                        </td>
