...
<div id="washed" class="displays" style="width:70%!important; margin:50px 20px!important">
    ...
    <div class="stocked_in">
        <div class="displays allResults" id="stocked_items">
            ...
            <table id="stock_items_table" class="searchTable">
                ...
                <tbody>
                    <?php
                        ...
                        $details = $get_items->fetch_details_3cond('sales', 'store', 'invoice', 'laundry_status', $store, $invoice, "I");
                    ...
                    <tr>
                        ...
                        <td>
                            <a style="color:#fff; background:green; padding:5px; border-radius:5px; font-size:.9rem" href="javascript:void(0) "title="Issue to customer" onclick="changeStatus('<?php echo $detail->sales_id?>', '<?php echo $invoice?>', 'issue_item.php', 'completed_items.php')">Issue <i class="fas fa-check-double"></i></a>
                        </td>
            ...
            ?>
                <button class="page_navs" id="back" onclick="showPage('completed_job.php')"><i class="fas fa-angle-double-left"></i> Return</button>
