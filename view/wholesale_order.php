...
<div id="sales_form" class="displays all_details">
    ...
    <div class="add_user_form" style="width:50%; margin:10px 0;">
        <h3 style="background:var(--primaryColor); color:#ff; text-align:left!important;" >Laundry order for <?php echo $customer_name ." (".$invoice.")"?></h3>
        
            <!-- search forms -->
        <!-- <form method="POST" id="addUserForm"> -->
            <section class="addUserForm">
                <div class="inputs">
                        <input type="hidden" name="customer" id="customer" value="<?php echo $customer?>" placeholder="Enter customer name or phone number">
